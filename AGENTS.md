...
name: vibepm-agent
description: |
  Configure an AI agent to work with VibePM as a fully unified project contributor.
  Can seamlessly switch between product management (planning), engineering (execution),
  and quality assurance (reviewing).
  Use when "VibePM agent", "project manager", "developer agent", "start work",
  "plan feature", or "agent setup".
---
